FROM quay.io/openshift-release-dev/ocp-v4.0-art-dev-test:ci-openshift-golang-builder-previous-rhel8-v4.18.0-20241025.150500
...
ENV __doozer=update BUILD_RELEASE=202410251504.p0.gfb58804.assembly.test.el8 BUILD_VERSION=v4.18.0 CI_RPM_SVC=base-4-18-rhel8.ocp.svc OS_GIT_MAJOR=4 OS_GIT_MINOR=18 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.18.0-202410251504.p0.gfb58804.assembly.test.el8 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.18 __doozer_key=ci-openshift-build-root-previous.rhel8 __doozer_uuid_tag=ci-openshift-build-root-previous-rhel8-v4.18.0-20241025.150500 __doozer_version=v4.18.0 
ENV __doozer=merge OS_GIT_COMMIT=fb58804 OS_GIT_VERSION=4.18.0-202410251504.p0.gfb58804.assembly.test.el8-fb58804 SOURCE_DATE_EPOCH=1729868363 SOURCE_GIT_COMMIT=fb588046251406fe7ce39850dac1b7ddd02dd9c0 SOURCE_GIT_TAG=openshift-4.0-archived-3606-gfb588046 SOURCE_GIT_URL=https://github.com/openshift-eng/ocp-build-data 
...
LABEL \
        ...
        version="v4.18.0" \
        release="202410251504.p0.gfb58804.assembly.test.el8" \
