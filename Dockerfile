...
ENV __doozer=update BUILD_RELEASE=202408290000.yuxzhu.p0.gb45ea65.assembly.stream.el9 BUILD_VERSION=v4.18.0 OS_GIT_MAJOR=4 OS_GIT_MINOR=18 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.18.0-202408290000.yuxzhu.p0.gb45ea65.assembly.stream.el9 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.18 __doozer_key=openshift-base-rhel9 __doozer_uuid_tag=base-rhel9-v4.18.0-20240913.140652 __doozer_version=v4.18.0 
