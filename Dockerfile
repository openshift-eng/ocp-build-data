FROM quay.io/openshift-release-dev/ocp-v4.0-art-dev-test:ose-base-v4.17.0-20241030.103140
...
ENV __doozer=update BUILD_RELEASE=202410301031.p0.g020e261.assembly.stream.el8 BUILD_VERSION=v4.17.0 CI_RPM_SVC=base-4-17-rhel8.ocp.svc OS_GIT_MAJOR=4 OS_GIT_MINOR=17 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.17.0-202410301031.p0.g020e261.assembly.stream.el8 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.17 __doozer_key=ci-openshift-base.rhel8 __doozer_uuid_tag=ci-openshift-base-rhel8-v4.17.0-20241030.103140 __doozer_version=v4.17.0 
