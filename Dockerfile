FROM quay.io/openshift-release-dev/ocp-v4.0-art-dev-test:ci-openshift-golang-builder-latest-rhel9-v4.18.0-20241029.085304
...
ENV __doozer=update BUILD_RELEASE=202410290853.p0.gc179d37.assembly.stream.el9 BUILD_VERSION=v4.18.0 CI_RPM_SVC=base-4-18-rhel9.ocp.svc OS_GIT_MAJOR=4 OS_GIT_MINOR=18 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.18.0-202410290853.p0.gc179d37.assembly.stream.el9 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.18 __doozer_key=ci-openshift-build-root-latest.rhel9 __doozer_uuid_tag=ci-openshift-build-root-latest-rhel9-v4.18.0-20241029.085304 __doozer_version=v4.18.0 
ENV __doozer=merge OS_GIT_COMMIT=c179d37 OS_GIT_VERSION=4.18.0-202410290853.p0.gc179d37.assembly.stream.el9-c179d37 SOURCE_DATE_EPOCH=1730149422 SOURCE_GIT_COMMIT=c179d3701ec23ba2c7723c9de01c7f42a67545fb SOURCE_GIT_TAG=openshift-4.0-archived-3612-gc179d370 SOURCE_GIT_URL=https://github.com/openshift-eng/ocp-build-data 
...
LABEL \
        ...
        version="v4.18.0" \
        release="202410290853.p0.gc179d37.assembly.stream.el9" \
