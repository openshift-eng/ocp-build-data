...
ENV __doozer=update __doozer_golang_nvr=golang-1.21.13-19.el8 __doozer_group=golang __doozer_key=openshift-golang-builder-1-21.rhel8 __doozer_uuid_tag=golang-builder-v1.21.13-20260826.070500 __doozer_version=v1.21.13 
...
LABEL \
        ...
        release="202608260704.p2.gedd1cdd.assembly.stream.el8" \
        io.openshift.build.golang-nvr="golang-1.21.13-19.el8" \
