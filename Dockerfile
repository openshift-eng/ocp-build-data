...
ENV __doozer=update __doozer_group=rhel-9-golang-1.25 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.25.9-20260513.054133 __doozer_version=v1.25.9 
...
LABEL \
        ...
        release="202605130541.p2.gdf787b0.el9" \
