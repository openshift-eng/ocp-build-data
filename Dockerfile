FROM brew.registry.redhat.io/rh-osbs/openshift-golang-builder:v1.21.11-202407030000.gab74a9a.el9
...
LABEL \
        ...
        name="openshift/ci-openshift-golang-builder-previous-rhel9" \
