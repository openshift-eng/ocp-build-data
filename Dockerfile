...
ENV __doozer=update __doozer_group=rhel-9-golang-1.20 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.20.12-20260127.161213 __doozer_version=v1.20.12 
...
LABEL \
        ...
        release="202601271612.g5f8d59d.el9" \
