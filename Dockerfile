FROM quay.io/openshift-release-dev/ocp-v4.0-art-dev-test:ci-openshift-golang-builder-previous-rhel8-v4.18.0-20241024.154403
...
ENV __doozer=update BUILD_RELEASE=202410241544.p0.g90d2bf0.assembly.test.el8 BUILD_VERSION=v4.18.0 CI_RPM_SVC=base-4-18-rhel8.ocp.svc OS_GIT_MAJOR=4 OS_GIT_MINOR=18 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.18.0-202410241544.p0.g90d2bf0.assembly.test.el8 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.18 __doozer_key=ci-openshift-build-root-previous.rhel8 __doozer_uuid_tag=ci-openshift-build-root-previous-rhel8-v4.18.0-20241024.154403 __doozer_version=v4.18.0 
ENV __doozer=merge OS_GIT_COMMIT=90d2bf0 OS_GIT_VERSION=4.18.0-202410241544.p0.g90d2bf0.assembly.test.el8-90d2bf0 SOURCE_DATE_EPOCH=1729750006 SOURCE_GIT_COMMIT=90d2bf0d6027691311ab8eb450b28244f4f9d12b SOURCE_GIT_TAG=openshift-4.0-archived-3599-g90d2bf0d SOURCE_GIT_URL=https://github.com/openshift-eng/ocp-build-data 
...
LABEL \
        ...
        version="v4.18.0" \
        release="202410241544.p0.g90d2bf0.assembly.test.el8" \
