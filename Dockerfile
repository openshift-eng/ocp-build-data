...
ENV __doozer=update __doozer_golang_nvr=golang-1.26.7-1.module+el8.10.0+24751+b3673b3e __doozer_group=golang __doozer_key=openshift-golang-builder-1-26.rhel8 __doozer_uuid_tag=golang-builder-v1.26.7-20260827.091830 __doozer_version=v1.26.7 
...
LABEL \
        ...
        io.openshift.build.golang-nvr="golang-1.26.7-1.module+el8.10.0+24751+b3673b3e" \
