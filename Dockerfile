FROM brew.registry.redhat.io/rh-osbs/openshift-golang-builder:v1.22.5-202407301728.gd58751c.el8
...
ENV __doozer=update BUILD_RELEASE=202409271506.p0.gbbcab63.assembly.test.el8 BUILD_VERSION=v4.18.0 CI_RPM_SVC=base-4-18-rhel8.ocp.svc OS_GIT_MAJOR=4 OS_GIT_MINOR=18 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.18.0-202409271506.p0.gbbcab63.assembly.test.el8 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.18 __doozer_key=ci-openshift-golang-builder-latest.rhel8 __doozer_uuid_tag=ci-openshift-golang-builder-latest-rhel8-v4.18.0-20240927.150625 __doozer_version=v4.18.0 
ENV __doozer=merge OS_GIT_COMMIT=bbcab63 OS_GIT_VERSION=4.18.0-202409271506.p0.gbbcab63.assembly.test.el8-bbcab63 SOURCE_DATE_EPOCH=1727374033 SOURCE_GIT_COMMIT=bbcab6394500f3c4ca85a5ecc229cf725bd96134 SOURCE_GIT_TAG=openshift-4.0-archived-3539-gbbcab639 SOURCE_GIT_URL=https://github.com/openshift-eng/ocp-build-data 
...
LABEL \
        ...
        version="v4.18.0" \
        release="202409271506.p0.gbbcab63.assembly.test.el8" \
        io.openshift.build.commit.id="bbcab6394500f3c4ca85a5ecc229cf725bd96134" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/bbcab6394500f3c4ca85a5ecc229cf725bd96134"
