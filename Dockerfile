...
ENV __doozer=update __doozer_golang_nvr=golang-1.25.11-1.el9_8 __doozer_group=rhel-9-golang-1.25 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.25.11-20260721.021257 __doozer_version=v1.25.11 
...
LABEL \
        ...
        release="202607210212.p2.g6245b3b.el9" \
        io.openshift.build.golang-nvr="golang-1.25.11-1.el9_8" \
        io.openshift.build.commit.id="6245b3b3ba21fad0e8d17ddd0fc65e1daa3e82aa" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/6245b3b3ba21fad0e8d17ddd0fc65e1daa3e82aa" \
