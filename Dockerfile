...
ENV __doozer=update __doozer_group=rhel-9-golang-1.22 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.22.12-20260518.174412 __doozer_version=v1.22.12 
...
LABEL \
        ...
        release="202605181744.p2.g6a298d3.el9" \
        io.openshift.build.commit.id="6a298d3cdc52095a93490c60fd388906c6cda36f" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/6a298d3cdc52095a93490c60fd388906c6cda36f" \
