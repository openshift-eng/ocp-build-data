...
ENV __doozer=update BUILD_RELEASE=202410031617.p0.g53e571d.assembly.test.el8 BUILD_VERSION=v4.18.0 CI_RPM_SVC=base-4-18-rhel8.ocp.svc OS_GIT_MAJOR=4 OS_GIT_MINOR=18 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.18.0-202410031617.p0.g53e571d.assembly.test.el8 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.18 __doozer_key=ci-openshift-golang-builder-previous.rhel8 __doozer_uuid_tag=ci-openshift-golang-builder-previous-rhel8-v4.18.0-20241003.161730 __doozer_version=v4.18.0 
ENV __doozer=merge OS_GIT_COMMIT=53e571d OS_GIT_VERSION=4.18.0-202410031617.p0.g53e571d.assembly.test.el8-53e571d SOURCE_DATE_EPOCH=1727883274 SOURCE_GIT_COMMIT=53e571ddc9348bbcd6548140d3c279193203a252 SOURCE_GIT_TAG=openshift-4.0-archived-3545-g53e571dd SOURCE_GIT_URL=https://github.com/openshift-eng/ocp-build-data 
...
LABEL \
        ...
        version="v4.18.0" \
        release="202410031617.p0.g53e571d.assembly.test.el8" \
