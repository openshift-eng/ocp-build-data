...
ENV __doozer=update __doozer_golang_nvr=golang-1.19.13-29.el8 __doozer_group=golang __doozer_key=openshift-golang-builder-1-19.rhel8 __doozer_uuid_tag=golang-builder-v1.19.13-20260909.185605 __doozer_version=v1.19.13 
...
LABEL \
        ...
        release="202609091855.p2.gedd1cdd.assembly.stream.el8" \
