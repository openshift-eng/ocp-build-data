...
ENV __doozer=update __doozer_golang_nvr=golang-1.20.12-32.el8 __doozer_group=golang __doozer_key=openshift-golang-builder-1-20.rhel8 __doozer_uuid_tag=golang-builder-v1.20.12-20260827.163022 __doozer_version=v1.20.12 
...
LABEL \
        ...
        io.openshift.build.golang-nvr="golang-1.20.12-32.el8" \
