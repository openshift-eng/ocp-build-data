...
ENV __doozer=update BUILD_RELEASE=202409251534.p0.g0fb79a4.assembly.test.el9 BUILD_VERSION=v4.18.0 OS_GIT_MAJOR=4 OS_GIT_MINOR=18 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.18.0-202409251534.p0.g0fb79a4.assembly.test.el9 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.18 __doozer_key=openshift-base-nodejs.rhel9 __doozer_uuid_tag=base-nodejs-rhel9-v4.18.0-20240925.153403 __doozer_version=v4.18.0 
ENV __doozer=merge OS_GIT_COMMIT=0fb79a4 OS_GIT_VERSION=4.18.0-202409251534.p0.g0fb79a4.assembly.test.el9-0fb79a4 SOURCE_DATE_EPOCH=1628716494 SOURCE_GIT_COMMIT=0fb79a4bfdfad72416f37f6a10e672d05b52ba9e SOURCE_GIT_TAG=0fb79a4b SOURCE_GIT_URL=https://github.com/openshift-eng/ocp-build-data 
# rhel-7 based:
...
LABEL \
        ...
        version="v4.18.0" \
        release="202409251534.p0.g0fb79a4.assembly.test.el9" \
