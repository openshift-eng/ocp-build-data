FROM quay.io/openshift-release-dev/ocp-v4.0-art-dev-test:ci-openshift-golang-builder-previous-rhel8-v4.18.0-20241028.080943
...
ENV __doozer=update BUILD_RELEASE=202410280809.p0.g8682161.assembly.stream.el8 BUILD_VERSION=v4.18.0 CI_RPM_SVC=base-4-18-rhel8.ocp.svc OS_GIT_MAJOR=4 OS_GIT_MINOR=18 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.18.0-202410280809.p0.g8682161.assembly.stream.el8 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.18 __doozer_key=ci-openshift-build-root-previous.rhel8 __doozer_uuid_tag=ci-openshift-build-root-previous-rhel8-v4.18.0-20241028.080943 __doozer_version=v4.18.0 
ENV __doozer=merge OS_GIT_COMMIT=8682161 OS_GIT_VERSION=4.18.0-202410280809.p0.g8682161.assembly.stream.el8-8682161 SOURCE_DATE_EPOCH=1730047304 SOURCE_GIT_COMMIT=86821614af4c60f1903a0d7762e0c488c384da30 SOURCE_GIT_TAG=openshift-4.0-archived-3608-g86821614 SOURCE_GIT_URL=https://github.com/openshift-eng/ocp-build-data 
...
LABEL \
        io.k8s.description="golang 1.21 build-root image for Red Hat CI" \
        name="openshift/ci-openshift-build-root-previous-rhel8" \
        com.redhat.component="ci-openshift-build-root-previous-container" \
        io.openshift.maintainer.project="OCPBUGS" \
        io.openshift.maintainer.component="Unknown" \
        version="v4.18.0" \
        release="202410280809.p0.g8682161.assembly.stream.el8" \
        io.openshift.build.commit.id="86821614af4c60f1903a0d7762e0c488c384da30" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/86821614af4c60f1903a0d7762e0c488c384da30"
