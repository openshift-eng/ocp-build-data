...
ENV __doozer=update __doozer_group=rhel-9-golang-1.21 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.21.13-20260513.090436 __doozer_version=v1.21.13 
...
LABEL \
        ...
        release="202605130904.p2.gb544aa4.el9" \
