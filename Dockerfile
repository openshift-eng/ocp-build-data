...
ENV __doozer=update __doozer_group=rhel-9-golang-1.23 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.23.10-20260427.145529 __doozer_version=v1.23.10 
...
LABEL \
        ...
        release="202604271455.p2.gbf0298b.el9" \
        io.openshift.build.commit.id="bf0298b1992afa51a4421f84fda971589fae1b07" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/bf0298b1992afa51a4421f84fda971589fae1b07" \
