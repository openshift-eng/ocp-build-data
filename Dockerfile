...
ENV __doozer=update __doozer_group=rhel-9-golang-1.25 __doozer_key=openshift-golang-builder-96 __doozer_uuid_tag=golang-builder-v1.25.9-20260427.145430 __doozer_version=v1.25.9 
...
LABEL \
        ...
        com.redhat.component="openshift-golang-builder-96-container" \
        io.openshift.maintainer.project="OCPBUGS" \
        io.openshift.maintainer.component="Unknown" \
        release="202604271454.p2.gf50c697.el9" \
        io.openshift.build.commit.id="f50c697690e62f17d05f4edab0a1df3c5db88c9f" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/f50c697690e62f17d05f4edab0a1df3c5db88c9f" \
