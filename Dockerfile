...
ENV __doozer=update __doozer_group=rhel-8-golang-1.25 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.25.8-20260415.084245 __doozer_version=v1.25.8 
...
LABEL \
        ...
        release="202604150842.p2.g2aa6a05.el8" \
