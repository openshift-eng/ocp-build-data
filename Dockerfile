FROM quay.io/openshift-release-dev/ocp-v4.0-art-dev-test:openshift-enterprise-base-rhel9-v4.18.0-20240927.174054
...
ENV __doozer=update BUILD_RELEASE=202409271740.p0.g3e99cf1.assembly.test.el9 BUILD_VERSION=v4.18.0 CI_RPM_SVC=base-4-18-rhel9.ocp.svc OS_GIT_MAJOR=4 OS_GIT_MINOR=18 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.18.0-202409271740.p0.g3e99cf1.assembly.test.el9 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.18 __doozer_key=ci-openshift-base.rhel9 __doozer_uuid_tag=ci-openshift-base-rhel9-v4.18.0-20240927.174054 __doozer_version=v4.18.0 
ENV __doozer=merge OS_GIT_COMMIT=3e99cf1 OS_GIT_VERSION=4.18.0-202409271740.p0.g3e99cf1.assembly.test.el9-3e99cf1 SOURCE_DATE_EPOCH=1727450310 SOURCE_GIT_COMMIT=3e99cf1526074dc9d8a03b555041c626a6bd36d4 SOURCE_GIT_TAG=openshift-4.0-archived-3540-g3e99cf15 SOURCE_GIT_URL=https://github.com/openshift-eng/ocp-build-data 
...
LABEL \
        ...
        version="v4.18.0" \
        release="202409271740.p0.g3e99cf1.assembly.test.el9" \
