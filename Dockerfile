FROM quay.io/openshift-release-dev/ocp-v4.0-art-dev-test:ci-openshift-golang-builder-previous-rhel9-v4.18.0-20241028.080943
...
ENV __doozer=update BUILD_RELEASE=202410280809.p0.g8682161.assembly.stream.el9 BUILD_VERSION=v4.18.0 CI_RPM_SVC=base-4-18-rhel9.ocp.svc OS_GIT_MAJOR=4 OS_GIT_MINOR=18 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.18.0-202410280809.p0.g8682161.assembly.stream.el9 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.18 __doozer_key=ci-openshift-build-root-previous.rhel9 __doozer_uuid_tag=ci-openshift-build-root-previous-rhel9-v4.18.0-20241028.080943 __doozer_version=v4.18.0 
ENV __doozer=merge OS_GIT_COMMIT=8682161 OS_GIT_VERSION=4.18.0-202410280809.p0.g8682161.assembly.stream.el9-8682161 SOURCE_DATE_EPOCH=1730047304 SOURCE_GIT_COMMIT=86821614af4c60f1903a0d7762e0c488c384da30 SOURCE_GIT_TAG=openshift-4.0-archived-3608-g86821614 SOURCE_GIT_URL=https://github.com/openshift-eng/ocp-build-data 
