FROM quay.io/openshift-release-dev/ocp-v4.0-art-dev-test:ci-openshift-golang-builder-previous-rhel9-v4.18.0-20241016.195524
...
ENV __doozer=update BUILD_RELEASE=202410161955.p0.g495d512.assembly.test.el9 BUILD_VERSION=v4.18.0 CI_RPM_SVC=base-4-18-rhel9.ocp.svc OS_GIT_MAJOR=4 OS_GIT_MINOR=18 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.18.0-202410161955.p0.g495d512.assembly.test.el9 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.18 __doozer_key=ci-openshift-build-root-previous.rhel9 __doozer_uuid_tag=ci-openshift-build-root-previous-rhel9-v4.18.0-20241016.195524 __doozer_version=v4.18.0 
...
LABEL \
        ...
        version="v4.18.0" \
        release="202410161955.p0.g495d512.assembly.test.el9" \
