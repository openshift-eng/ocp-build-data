...
ENV __doozer=update __doozer_golang_nvr=golang-1.24.13-9.el8_10 __doozer_group=golang __doozer_key=openshift-golang-builder-1-24.rhel8 __doozer_uuid_tag=golang-builder-v1.24.13-20260807.163916 __doozer_version=v1.24.13 
...
LABEL \
        ...
        release="202608071639.p2.g9e54c20.el8" \
        io.openshift.build.golang-nvr="golang-1.24.13-9.el8_10" \
