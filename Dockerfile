...
ENV __doozer=update __doozer_group=rhel-9-golang-1.24 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.24.13-20260415.112552 __doozer_version=v1.24.13 
...
LABEL \
        ...
        release="202604151125.p2.g04d2cd5.el9" \
