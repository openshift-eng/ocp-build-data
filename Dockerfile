...
ENV __doozer=update __doozer_golang_nvr=golang-1.25.14-1.el9 __doozer_group=golang __doozer_key=openshift-golang-builder-1-25.rhel9 __doozer_uuid_tag=golang-builder-v1.25.14-20260902.183956 __doozer_version=v1.25.14 
...
LABEL \
        ...
        release="202609021839.p2.gedd1cdd.assembly.stream.el9" \
        io.openshift.build.golang-nvr="golang-1.25.14-1.el9" \
