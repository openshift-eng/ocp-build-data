...
ENV __doozer=update __doozer_golang_nvr=golang-1.26.4-1.el9_8 __doozer_group=rhel-9-golang-1.26 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.26.4-20260708.221610 __doozer_version=v1.26.4 
...
LABEL \
        ...
        release="202607082216.p2.g48af02f.el9" \
        io.openshift.build.golang-nvr="golang-1.26.4-1.el9_8" \
        io.openshift.build.commit.id="48af02f4f7fef2e8dcb00bf1578fbc2286dd2e56" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/48af02f4f7fef2e8dcb00bf1578fbc2286dd2e56" \
