...
ENV __doozer=update __doozer_golang_nvr=golang-1.26.4-1.el9_8 __doozer_group=rhel-9-golang-1.26 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.26.4-20260709.091847 __doozer_version=v1.26.4 
...
LABEL \
        ...
        release="202607090918.p2.g48af02f.el9" \
