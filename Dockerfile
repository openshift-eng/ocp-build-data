...
ENV __doozer=update __doozer_golang_nvr=golang-1.24.13-12.el8_10 __doozer_group=golang __doozer_key=openshift-golang-builder-1-24.rhel8 __doozer_uuid_tag=golang-builder-v1.24.13-20260827.163105 __doozer_version=v1.24.13 
...
LABEL \
        ...
        io.openshift.build.golang-nvr="golang-1.24.13-12.el8_10" \
