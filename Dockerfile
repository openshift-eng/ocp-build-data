...
ENV __doozer=update __doozer_golang_nvr=golang-1.26.7-1.el9_8 __doozer_group=golang __doozer_key=openshift-golang-builder-1-26.rhel9 __doozer_uuid_tag=golang-builder-v1.26.7-20260902.140512 __doozer_version=v1.26.7 
...
LABEL \
        ...
        release="202609021405.p2.gedd1cdd.assembly.test.el9" \
