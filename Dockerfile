...
ENV __doozer=update __doozer_group=rhel-8-golang-1.20 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.20.12-20260410.110116 __doozer_version=v1.20.12 
...
LABEL \
        ...
        release="202604101100.p2.g6e050e4.el8" \
