...
ENV __doozer=update __doozer_golang_nvr=golang-1.22.12-18.el8 __doozer_group=golang __doozer_key=openshift-golang-builder-1-22.rhel8 __doozer_uuid_tag=golang-builder-v1.22.12-20260812.184222 __doozer_version=v1.22.12 
...
LABEL \
        ...
        release="202608121842.p2.g7d3050a.assembly.stream.el8" \
        io.openshift.build.golang-nvr="golang-1.22.12-18.el8" \
