...
ENV __doozer=update __doozer_group=rhel-9-golang-1.26 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.26.1-20260420.201042 __doozer_version=v1.26.1 
...
LABEL \
        ...
        release="202604202010.p2.g43aca9a.el9" \
