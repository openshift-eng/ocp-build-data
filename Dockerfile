...
ENV __doozer=update BUILD_RELEASE=202409271837.p0.gb45ea65.assembly.test.el9 BUILD_VERSION=v4.18.0 OS_GIT_MAJOR=4 OS_GIT_MINOR=18 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.18.0-202409271837.p0.gb45ea65.assembly.test.el9 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.18 __doozer_key=openshift-base-rhel9 __doozer_uuid_tag=base-rhel9-v4.18.0-20240927.183716 __doozer_version=v4.18.0 
ENV __doozer=merge OS_GIT_COMMIT=b45ea65 OS_GIT_VERSION=4.18.0-202409271837.p0.gb45ea65.assembly.test.el9-b45ea65 SOURCE_DATE_EPOCH=1654869156 SOURCE_GIT_COMMIT=b45ea65bf6606c558b1a18b92ad878f42a411894 SOURCE_GIT_TAG=b45ea65b SOURCE_GIT_URL=https://github.com/openshift-eng/ocp-build-data 
...
LABEL \
        ...
        version="v4.18.0" \
        release="202409271837.p0.gb45ea65.assembly.test.el9" \
