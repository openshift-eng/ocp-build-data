...
ENV __doozer=update __doozer_golang_nvr=golang-1.26.5-1.module+el8.10.0+24506+6809f2d9 __doozer_group=golang __doozer_key=openshift-golang-builder-1-26.rhel8 __doozer_uuid_tag=golang-builder-v1.26.5-20260727.200254 __doozer_version=v1.26.5 
...
LABEL \
        ...
        release="202607272002.p2.g5a9ab9d.el8" \
