...
ENV __doozer=update __doozer_group=rhel-9-golang-1.19 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.19.13-20260513.102343 __doozer_version=v1.19.13 
...
LABEL \
        ...
        release="202605131023.p2.g805400d.el9" \
        io.openshift.build.commit.id="805400d2109537054d3ca37afd738cbe46c50f5b" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/805400d2109537054d3ca37afd738cbe46c50f5b" \
