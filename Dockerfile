...
ENV __doozer=update BUILD_RELEASE=202409271522.p0.g3e99cf1.assembly.test.el9 BUILD_VERSION=v4.18.0 CI_RPM_SVC=base-4-18-rhel9.ocp.svc OS_GIT_MAJOR=4 OS_GIT_MINOR=18 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.18.0-202409271522.p0.g3e99cf1.assembly.test.el9 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.18 __doozer_key=ci-openshift-golang-builder-latest.rhel9 __doozer_uuid_tag=ci-openshift-golang-builder-latest-rhel9-v4.18.0-20240927.152212 __doozer_version=v4.18.0 
