FROM quay.io/openshift-release-dev/ocp-v4.0-art-dev-test:ci-openshift-golang-builder-previous-rhel8-v4.18.0-20241014.191751
...
ENV __doozer=update BUILD_RELEASE=202410141917.p0.gcfe6cbe.assembly.test.el8 BUILD_VERSION=v4.18.0 CI_RPM_SVC=base-4-18-rhel8.ocp.svc OS_GIT_MAJOR=4 OS_GIT_MINOR=18 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.18.0-202410141917.p0.gcfe6cbe.assembly.test.el8 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.18 __doozer_key=ci-openshift-build-root-previous.rhel8 __doozer_uuid_tag=ci-openshift-build-root-previous-rhel8-v4.18.0-20241014.191751 __doozer_version=v4.18.0 
ENV __doozer=merge OS_GIT_COMMIT=cfe6cbe OS_GIT_VERSION=4.18.0-202410141917.p0.gcfe6cbe.assembly.test.el8-cfe6cbe SOURCE_DATE_EPOCH=1728929777 SOURCE_GIT_COMMIT=cfe6cbe5ca846776a9107db8fed1d4cf0cacbcbc SOURCE_GIT_TAG=openshift-4.0-archived-3581-gcfe6cbe5 SOURCE_GIT_URL=https://github.com/openshift-eng/ocp-build-data 
...
LABEL \
        ...
        version="v4.18.0" \
        release="202410141917.p0.gcfe6cbe.assembly.test.el8" \
