...
ENV __doozer=update __doozer_group=rhel-9-golang-1.23 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.23.10-20260424.172015 __doozer_version=v1.23.10 
...
LABEL \
        ...
        release="202604241720.p2.g0e526f5.el9" \
        io.openshift.build.commit.id="0e526f53df51323add1aa972cf652523fe896878" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/0e526f53df51323add1aa972cf652523fe896878" \
