...
ENV __doozer=update __doozer_golang_nvr=golang-1.23.10-20.el8 __doozer_group=golang __doozer_key=openshift-golang-builder-1-23.rhel8 __doozer_uuid_tag=golang-builder-v1.23.10-20260903.183740 __doozer_version=v1.23.10 
...
LABEL \
        ...
        release="202609031837.p2.gedd1cdd.assembly.stream.el8" \
        io.openshift.build.golang-nvr="golang-1.23.10-20.el8" \
