...
ENV __doozer=update __doozer_golang_nvr=golang-1.24.13-11.el9_8 __doozer_group=golang __doozer_key=openshift-golang-builder-1-24.rhel9 __doozer_uuid_tag=golang-builder-v1.24.13-20260817.204049 __doozer_version=v1.24.13 
...
LABEL \
        ...
        release="202608172040.p2.gedd1cdd.assembly.stream.el9" \
