...
ENV __doozer=update BUILD_RELEASE=202410241604.p0.g90d2bf0.assembly.test.el8 BUILD_VERSION=v4.18.0 CI_RPM_SVC=base-4-18-rhel8.ocp.svc OS_GIT_MAJOR=4 OS_GIT_MINOR=18 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.18.0-202410241604.p0.g90d2bf0.assembly.test.el8 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.18 __doozer_key=ci-openshift-golang-builder-previous.rhel8 __doozer_uuid_tag=ci-openshift-golang-builder-previous-rhel8-v4.18.0-20241024.160420 __doozer_version=v4.18.0 
