...
ENV __doozer=update __doozer_group=rhel-8-golang-1.21 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.21.13-20260609.172650 __doozer_version=v1.21.13 
...
LABEL \
        ...
        release="202606091726.p2.g41d6a48.el8" \
