...
ENV __doozer=update __doozer_golang_nvr=golang-1.19.13-27.el8 __doozer_group=golang __doozer_key=openshift-golang-builder-1-19.rhel8 __doozer_uuid_tag=golang-builder-v1.19.13-20260812.185432 __doozer_version=v1.19.13 
...
LABEL \
        ...
        release="202608121854.p2.g7d3050a.assembly.stream.el8" \
        io.openshift.build.golang-nvr="golang-1.19.13-27.el8" \
