...
ENV __doozer=update __doozer_group=rhel-9-golang-1.22 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.22.12-20260507.150212 __doozer_version=v1.22.12 
...
LABEL \
        ...
        release="202605071502.p2.g6a298d3.el9" \
