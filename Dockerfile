...
ENV __doozer=update BUILD_RELEASE=202410081732.p0.gf020942.assembly.test.el8 BUILD_VERSION=v4.18.0 OS_GIT_MAJOR=4 OS_GIT_MINOR=18 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.18.0-202410081732.p0.gf020942.assembly.test.el8 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.18 __doozer_key=openshift-base-rhel8 __doozer_uuid_tag=base-rhel8-v4.18.0-20241008.173240 __doozer_version=v4.18.0 
ENV __doozer=merge OS_GIT_COMMIT=f020942 OS_GIT_VERSION=4.18.0-202410081732.p0.gf020942.assembly.test.el8-f020942 SOURCE_DATE_EPOCH=1650510022 SOURCE_GIT_COMMIT=f02094204c5dab97e4ccadd35d135a2ef12c341f SOURCE_GIT_TAG=f0209420 SOURCE_GIT_URL=https://github.com/openshift-eng/ocp-build-data 
...
LABEL \
        ...
        version="v4.18.0" \
        release="202410081732.p0.gf020942.assembly.test.el8" \
