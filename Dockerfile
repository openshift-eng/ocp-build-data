...
ENV __doozer=update __doozer_group=rhel-8-golang-1.20 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.20.12-20260610.145448 __doozer_version=v1.20.12 
...
LABEL \
        ...
        release="202606101454.p2.gb566c1e.el8" \
        io.openshift.build.golang-nvr="golang-1.20.12-25.el8" \
        io.openshift.build.commit.id="b566c1e686d4c83a227391485391198a9b03e4f6" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/b566c1e686d4c83a227391485391198a9b03e4f6" \
