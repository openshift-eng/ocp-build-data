...
ENV __doozer=update __doozer_group=rhel-9-golang-1.22 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.22.12-20260128.164838 __doozer_version=v1.22.12 
...
LABEL \
        ...
        release="202601281648.g388ceb2.el9" \
