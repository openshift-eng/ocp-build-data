...
ENV __doozer=update __doozer_group=rhel-8-golang-1.24 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.24.13-20260518.191325 __doozer_version=v1.24.13 
...
LABEL \
        ...
        release="202605181913.p2.g3562721.el8" \
        io.openshift.build.commit.id="3562721fd9151b0122819b56af7e5bfad74f0c8a" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/3562721fd9151b0122819b56af7e5bfad74f0c8a" \
