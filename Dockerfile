...
ENV __doozer=update __doozer_group=rhel-9-golang-1.26 __doozer_key=openshift-golang-builder __doozer_uuid_tag=golang-builder-v1.26.2-20260515.214721 __doozer_version=v1.26.2 
...
LABEL \
        ...
        release="202605152147.p2.gb1b9903.el9" \
        io.openshift.build.commit.id="b1b99031f757c390ccdda5caf18eafdb8ef9a9bd" \
        io.openshift.build.source-location="https://github.com/openshift-eng/ocp-build-data" \
        io.openshift.build.commit.url="https://github.com/openshift-eng/ocp-build-data/commit/b1b99031f757c390ccdda5caf18eafdb8ef9a9bd" \
